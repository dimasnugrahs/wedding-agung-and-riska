        ...
        <div className="bg-white md:px-24 p-8 rounded-xl border border-zinc-200/60 shadow-sm space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-zinc-500  max-w-sm mx-auto leading-relaxed font-light">
              Kamis, 20 Oktober 2026 <span className="text-zinc-500">•</span>{" "}
              09.00 - Selesai
            </p>
          </div>
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 bg-linear-to-b from-black/70 via-black/40 to-black/80  text-white text-[11px] tracking-widest uppercase font-medium px-6 py-3 rounded-full transition-all shadow-sm group"
            >
              <svg
