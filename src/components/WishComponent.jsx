      ...
      <div className="max-w-2xl mx-auto space-y-10">
        <div className="space-y-4 px-4">
          ...
          <motion.p
            ...
            className="text-white text-[18px] md:text-[20px] md:text-zinc-900"
          >
          ...
          <motion.p
            ...
            className="text-zinc-400 md:text-zinc-600 font-light text-sm max-w-xl mx-auto leading-relaxed"
          >
