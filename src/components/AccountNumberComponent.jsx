      ...
      <div className="relative z-10 my-auto flex flex-col items-center w-full max-w-md text-center space-y-8">
        ...
        <div className="space-y-4">
          <div className="relative inline-block">
            <h2 className="font-serif text-4xl text-stone-200/90 font-light tracking-wide">
              Amplop
            </h2>
            <h3 className="font-serif text-5xl text-stone-400 italic font-normal -mt-3 ml-12 tracking-wider">
              Digital
            </h3>
          </div>
            ...
            >
              ...
              >
                <path
                  ...
                  d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125v-9.75A1.125 1.125 0 0 1 4.875 11.25H8.25m2.25 2.25h9.75c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125v-9.75c0-.621.504-1.125 1.125-1.125"
                />
              </svg>
              Copy No. Rekening
            </button>
